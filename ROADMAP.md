...
This repository represents my skills of work with native PHP 8+ modules without any frameworks and follows strict set of requirements of the test task.

## Requirements

This must be a simple working example of the blog constructed on pure PHP without use of any frameworks.
...
- [x] Docker infrastructure
    ...
    - [x] Docker compose file with next containers
